...
#    Private endpoints
    ...
    def updateEquation(self, ad_id):
        return self.sendRequest('api/ad-equation/' + ad_id + '/', '', 'post')

    def getAllNotifications(self):
        return self.sendRequest('/api/notifications/', '', 'get')

    def markNotificationAsRead(self, notif_id):
        return self.sendRequest('api/notifications/mark_as_read/' + notif_id + '/', '', 'post')
